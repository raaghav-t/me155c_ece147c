...
## Generated on : Mon May 05 18:35:20 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Controller.rt-win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Controller.rt-win64
...
SRCS = $(START_DIR)\Controller_quarc_win64\Controller.c $(START_DIR)\Controller_quarc_win64\Controller_data.c $(START_DIR)\Controller_quarc_win64\Controller_main.c $(START_DIR)\Controller_quarc_win64\rtGetInf.c $(START_DIR)\Controller_quarc_win64\rtGetNaN.c $(START_DIR)\Controller_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Controller.obj Controller_data.obj Controller_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Controller_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Controller_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Controller.obj : "$(START_DIR)\Controller_quarc_win64\Controller.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_quarc_win64\Controller.c"


Controller_data.obj : "$(START_DIR)\Controller_quarc_win64\Controller_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_quarc_win64\Controller_data.c"


Controller_main.obj : "$(START_DIR)\Controller_quarc_win64\Controller_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_quarc_win64\Controller_main.c"


rtGetInf.obj : "$(START_DIR)\Controller_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Controller_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Controller_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Controller_quarc_win64\rt_nonfinite.c"
