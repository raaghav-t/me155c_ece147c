 ...
 * C source code generated on : Mon May  5 19:23:05 2025
 *
...
RT_MODEL_Controller_T *Controller(void)
{
  ...
  /* External mode info */
  Controller_M->Sizes.checksums[0] = (212313677U);
  Controller_M->Sizes.checksums[1] = (524139509U);
  Controller_M->Sizes.checksums[2] = (310052537U);
  Controller_M->Sizes.checksums[3] = (1165473361U);
