###########################################################################
## Makefile generated for component 'CL_modelid'. 
## 
## Makefile     : CL_modelid.mk
## Generated on : Fri May 30 12:07:07 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\CL_modelid.rt-win64
...
COMPILER_COMMAND_FILE     = CL_modelid_comp.rsp
CMD_FILE                  = CL_modelid.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\CL_modelid.rt-win64
...
DEFINES_STANDARD = -DMODEL=CL_modelid -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\CL_modelid_quarc_win64\CL_modelid.c $(START_DIR)\CL_modelid_quarc_win64\CL_modelid_data.c $(START_DIR)\CL_modelid_quarc_win64\CL_modelid_main.c $(START_DIR)\CL_modelid_quarc_win64\rtGetInf.c $(START_DIR)\CL_modelid_quarc_win64\rtGetNaN.c $(START_DIR)\CL_modelid_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = CL_modelid.obj CL_modelid_data.obj CL_modelid_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\CL_modelid_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CL_modelid_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
CL_modelid.obj : "$(START_DIR)\CL_modelid_quarc_win64\CL_modelid.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CL_modelid_quarc_win64\CL_modelid.c"


CL_modelid_data.obj : "$(START_DIR)\CL_modelid_quarc_win64\CL_modelid_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CL_modelid_quarc_win64\CL_modelid_data.c"


CL_modelid_main.obj : "$(START_DIR)\CL_modelid_quarc_win64\CL_modelid_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CL_modelid_quarc_win64\CL_modelid_main.c"


rtGetInf.obj : "$(START_DIR)\CL_modelid_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CL_modelid_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\CL_modelid_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CL_modelid_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\CL_modelid_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CL_modelid_quarc_win64\rt_nonfinite.c"
