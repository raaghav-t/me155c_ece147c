...
## Generated on : Thu May 29 17:15:06 2025
...
PRODUCT_NAME              = Copy_of_Controller
MAKEFILE                  = Copy_of_Controller.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\colegiusto\me155c_ece147c\Final_v2\model_id
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Copy_of_Controller_comp.rsp
CMD_FILE                  = Copy_of_Controller.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Copy_of_Controller.rt-win64
...
DEFINES_STANDARD = -DMODEL=Copy_of_Controller -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller.c $(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller_data.c $(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller_main.c $(START_DIR)\Copy_of_Controller_quarc_win64\rtGetInf.c $(START_DIR)\Copy_of_Controller_quarc_win64\rtGetNaN.c $(START_DIR)\Copy_of_Controller_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Copy_of_Controller.obj Copy_of_Controller_data.obj Copy_of_Controller_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Copy_of_Controller_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Copy_of_Controller_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Copy_of_Controller.obj : "$(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller.c"


Copy_of_Controller_data.obj : "$(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller_data.c"


Copy_of_Controller_main.obj : "$(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Copy_of_Controller_quarc_win64\Copy_of_Controller_main.c"


rtGetInf.obj : "$(START_DIR)\Copy_of_Controller_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Copy_of_Controller_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Copy_of_Controller_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Copy_of_Controller_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Copy_of_Controller_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Copy_of_Controller_quarc_win64\rt_nonfinite.c"
