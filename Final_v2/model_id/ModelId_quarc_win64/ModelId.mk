...
## 
## Makefile     : ModelId.mk
## Generated on : Wed May 28 17:09:00 2025
...
COMPILER_COMMAND_FILE     = ModelId_comp.rsp
CMD_FILE                  = ModelId.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ModelId.rt-win64
...
DEFINES_STANDARD = -DMODEL=ModelId -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\ModelId_quarc_win64\ModelId.c $(START_DIR)\ModelId_quarc_win64\ModelId_data.c $(START_DIR)\ModelId_quarc_win64\ModelId_main.c $(START_DIR)\ModelId_quarc_win64\rtGetInf.c $(START_DIR)\ModelId_quarc_win64\rtGetNaN.c $(START_DIR)\ModelId_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = ModelId.obj ModelId_data.obj ModelId_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\ModelId_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ModelId_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ModelId.obj : "$(START_DIR)\ModelId_quarc_win64\ModelId.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ModelId_quarc_win64\ModelId.c"


ModelId_data.obj : "$(START_DIR)\ModelId_quarc_win64\ModelId_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ModelId_quarc_win64\ModelId_data.c"


ModelId_main.obj : "$(START_DIR)\ModelId_quarc_win64\ModelId_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ModelId_quarc_win64\ModelId_main.c"


rtGetInf.obj : "$(START_DIR)\ModelId_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ModelId_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\ModelId_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ModelId_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\ModelId_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ModelId_quarc_win64\rt_nonfinite.c"
