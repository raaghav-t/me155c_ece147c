...
typedef RT_MODEL_Copy_of_Controller_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Copy_of_Controller(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Copy_of_Controller_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Copy_of_Controller -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
