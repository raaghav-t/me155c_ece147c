...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&Copy_of_Controller_B.raag), 0, 0, 27 }
  ,

  { (char_T *)(&Copy_of_Controller_DW.MemoryX_DSTATE[0]), 0, 0, 31 },
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&Copy_of_Controller_P.K[0]), 0, 0, 7 },

  { (char_T *)(&Copy_of_Controller_P.cartangle_channels), 7, 0, 3 },

  { (char_T *)(&Copy_of_Controller_P.Lykyhatkk1_Y0), 0, 0, 180 },
