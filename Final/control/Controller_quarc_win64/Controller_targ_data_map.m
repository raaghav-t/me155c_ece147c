    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% Controller_P.HILReadEncoder1_channels
            ...
            section.data(35)  = dumData; %prealloc
                    ...
                    ;% Controller_P.DiscreteTransferFcn_NumCoef
                    section.data(16).logicalSrcIdx = 18;
                    section.data(16).dtTransOffset = 15;

                    ;% Controller_P.DiscreteTransferFcn_DenCoef
                    ...
                    ;% Controller_P.DiscreteTransferFcn2_NumCoef
                    section.data(19).logicalSrcIdx = 21;
                    section.data(19).dtTransOffset = 58;

                    ;% Controller_P.DiscreteTransferFcn2_DenCoef
                    ...
                    ;% Controller_P.DiscreteTransferFcn3_NumCoef
                    section.data(22).logicalSrcIdx = 24;
                    section.data(22).dtTransOffset = 101;

                    ;% Controller_P.DiscreteTransferFcn3_DenCoef
                    ...
                    ;% Controller_P.DiscreteTransferFcn4_NumCoef
                    section.data(25).logicalSrcIdx = 27;
                    section.data(25).dtTransOffset = 144;

                    ;% Controller_P.DiscreteTransferFcn4_DenCoef
            ...
            section.data(38)  = dumData; %prealloc
                    ...
                    ;% Controller_P.HILReadEncoder1_Active
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% Controller_B.TmpSignalConversionAtToWorkspac
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% Controller_DW.DiscreteTransferFcn2_states
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 20;

                    ;% Controller_DW.DiscreteTransferFcn3_states
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 40;

                    ;% Controller_DW.DiscreteTransferFcn4_states
                    section.data(4).logicalSrcIdx = 3;
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% Controller_DW.HILReadEncoder1_PWORK
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% Controller_DW.HILReadEncoder1_Buffer
    ...
    targMap.checksum0 = 2641290014;
    targMap.checksum1 = 1010923709;
    targMap.checksum2 = 1699999240;
    targMap.checksum3 = 3714804386;
