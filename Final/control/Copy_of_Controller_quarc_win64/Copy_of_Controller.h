...
typedef struct {
  ...
  real_T DiscreteTransferFcn4;         /* '<Root>/Discrete Transfer Fcn4' */
  real_T u;                            /* '<Root>/u' */
  real_T raag[2];                      /* '<Root>/Gain' */
  real_T raag_d[2];                    /* '<Root>/Gain2' */
...
typedef struct {
  real_T DiscreteTransferFcn_states[20];/* '<Root>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn2_states[20];/* '<Root>/Discrete Transfer Fcn2' */
  real_T DiscreteTransferFcn3_states[20];/* '<Root>/Discrete Transfer Fcn3' */
  real_T DiscreteTransferFcn4_states[20];/* '<Root>/Discrete Transfer Fcn4' */
  ...
  int32_T HILReadEncoder1_Buffer[2];   /* '<Root>/HIL Read Encoder1' */
...
struct P_Copy_of_Controller_T_ {
  uint32_T HILReadEncoder_channels[2];/* Mask Parameter: HILReadEncoder_channels
                                       ...
                                       */
  uint32_T HILReadEncoder1_channels[2];
  ...
  real_T HILInitialize_POInitial;      /* Expression: initial_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T DiscreteTransferFcn_NumCoef[21];/* Expression: num_d{1}
                                          * Referenced by: '<Root>/Discrete Transfer Fcn'
                                          */
  real_T DiscreteTransferFcn_DenCoef[21];/* Expression: den_d{1}
                                          * Referenced by: '<Root>/Discrete Transfer Fcn'
                                          */
  real_T DiscreteTransferFcn_InitialStat;/* Expression: 0
                                          * Referenced by: '<Root>/Discrete Transfer Fcn'
                                          */
  real_T DiscreteTransferFcn2_NumCoef[21];/* Expression: num_d{2}
                                           * Referenced by: '<Root>/Discrete Transfer Fcn2'
                                           */
  real_T DiscreteTransferFcn2_DenCoef[21];/* Expression: den_d{2}
                                           * Referenced by: '<Root>/Discrete Transfer Fcn2'
                                           */
  real_T DiscreteTransferFcn2_InitialSta;/* Expression: 0
                                          * Referenced by: '<Root>/Discrete Transfer Fcn2'
                                          */
  real_T DiscreteTransferFcn3_NumCoef[21];/* Expression: num_d{3}
                                           * Referenced by: '<Root>/Discrete Transfer Fcn3'
                                           */
  real_T DiscreteTransferFcn3_DenCoef[21];/* Expression: den_d{3}
                                           * Referenced by: '<Root>/Discrete Transfer Fcn3'
                                           */
  real_T DiscreteTransferFcn3_InitialSta;/* Expression: 0
                                          * Referenced by: '<Root>/Discrete Transfer Fcn3'
                                          */
  real_T DiscreteTransferFcn4_NumCoef[21];/* Expression: num_d{4}
                                           * Referenced by: '<Root>/Discrete Transfer Fcn4'
                                           */
  real_T DiscreteTransferFcn4_DenCoef[21];/* Expression: den_d{4}
                                           * Referenced by: '<Root>/Discrete Transfer Fcn4'
                                           */
