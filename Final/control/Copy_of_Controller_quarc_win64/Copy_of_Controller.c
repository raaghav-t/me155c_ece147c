...
void Copy_of_Controller_output(void)
{
  ...
  denIdx = 1;
  for (j = 0; j < 20; j++) {
    rtb_Saturation += Copy_of_Controller_P.DiscreteTransferFcn_NumCoef[denIdx] *
      Copy_of_Controller_DW.DiscreteTransferFcn_states[j];
    denIdx++;
  }

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn' */
  Copy_of_Controller_B.DiscreteTransferFcn = rtb_Saturation;

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn2' */
  rtb_Saturation = 0.0;
  denIdx = 1;
  for (j = 0; j < 20; j++) {
    rtb_Saturation += Copy_of_Controller_P.DiscreteTransferFcn2_NumCoef[denIdx] *
      Copy_of_Controller_DW.DiscreteTransferFcn2_states[j];
    denIdx++;
  }

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn2' */
  Copy_of_Controller_B.DiscreteTransferFcn2 = rtb_Saturation;

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn3' */
  rtb_Saturation = 0.0;
  denIdx = 1;
  for (j = 0; j < 20; j++) {
    rtb_Saturation += Copy_of_Controller_P.DiscreteTransferFcn3_NumCoef[denIdx] *
      Copy_of_Controller_DW.DiscreteTransferFcn3_states[j];
    denIdx++;
  }

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn3' */
  Copy_of_Controller_B.DiscreteTransferFcn3 = rtb_Saturation;
  ...
  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn4' */
  Copy_of_Controller_B.DiscreteTransferFcn4 = rtb_Saturation;

  /* Sum: '<Root>/u' incorporates:
   *  Gain: '<Root>/Gain1'
   *  Sum: '<Root>/Sum'
   */
  Copy_of_Controller_B.u = (((Copy_of_Controller_B.DiscreteTransferFcn +
    Copy_of_Controller_B.DiscreteTransferFcn2) +
    Copy_of_Controller_B.DiscreteTransferFcn3) +
    Copy_of_Controller_B.DiscreteTransferFcn4) * Copy_of_Controller_P.Gain1_Gain;
  ...
  /* Gain: '<Root>/Gain2' */
  rtb_Saturation = Copy_of_Controller_P.Gain2_Gain * rtb_HILReadEncoder1[0];
  Copy_of_Controller_B.raag_d[0] = rtb_Saturation;
  ...
  Copy_of_Controller_B.TmpSignalConversionAtToWorkspac[2] = rtb_Saturation;

  /* Gain: '<Root>/Gain2' */
  rtb_Saturation = Copy_of_Controller_P.Gain2_Gain * rtb_HILReadEncoder1[1];
  Copy_of_Controller_B.raag_d[1] = rtb_Saturation;

  /* SignalConversion generated from: '<Root>/To Workspace' */
  Copy_of_Controller_B.TmpSignalConversionAtToWorkspac[1] =
    Copy_of_Controller_B.raag[1];
  Copy_of_Controller_B.TmpSignalConversionAtToWorkspac[3] = rtb_Saturation;
...
RT_MODEL_Copy_of_Controller_T *Copy_of_Controller(void)
{
  ...
  /* External mode info */
  Copy_of_Controller_M->Sizes.checksums[0] = (2043893024U);
  Copy_of_Controller_M->Sizes.checksums[1] = (323108212U);
  Copy_of_Controller_M->Sizes.checksums[2] = (329295229U);
  Copy_of_Controller_M->Sizes.checksums[3] = (3220679091U);
  ...
  Copy_of_Controller_M->Sizes.numBlocks = (24);/* Number of blocks */
