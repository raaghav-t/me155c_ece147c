...
#ifndef RTW_HEADER_ModelId_h_
#define RTW_HEADER_ModelId_h_
#ifndef ModelId_COMMON_INCLUDES_
#define ModelId_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* ModelId_COMMON_INCLUDES_ */

#include "ModelId_types.h"
...
#define ModelId_rtModel                RT_MODEL_ModelId_T

/* Block signals (default storage) */
typedef struct {
  real_T raag[2];                      /* '<Root>/Gain1' */
  real_T raag_l[2];                    /* '<Root>/Gain' */
...
#define rtB                            ModelId_B
#define BlockIO                        B_ModelId_T
#define rtP                            ModelId_P
#define Parameters                     P_ModelId_T
#define rtDWork                        ModelId_DW
#define D_Work                         DW_ModelId_T
...
extern P_ModelId_T ModelId_P;

/* Block signals (default storage) */
extern B_ModelId_T ModelId_B;

/* Block states (default storage) */
extern DW_ModelId_T ModelId_DW;

/* Model entry point functions */
extern void ModelId_initialize(void);
extern void ModelId_output(void);
extern void ModelId_update(void);
extern void ModelId_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ModelId_rtModel *ModelId(void);
...
extern RT_MODEL_ModelId_T *const ModelId_M;
