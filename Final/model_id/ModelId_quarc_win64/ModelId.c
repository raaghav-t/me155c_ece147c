 ...
 * C source code generated on : Thu May 15 20:58:41 2025
 *
...
void ModelId_output(void)
{
  ...
  /* S-Function Block: ModelId/HIL Read Encoder1 (hil_read_encoder_block) */
  {
    t_error result = hil_read_encoder(ModelId_DW.HILInitialize_Card,
      ModelId_P.HILReadEncoder1_channels, 2, &ModelId_DW.HILReadEncoder1_Buffer
      [0]);
    if (result < 0) {
      ...
      rtb_HILReadEncoder[0] = ModelId_DW.HILReadEncoder1_Buffer[0];
      rtb_HILReadEncoder[1] = ModelId_DW.HILReadEncoder1_Buffer[1];
    }
  }

  /* Gain: '<Root>/Gain1' */
  ModelId_B.raag[0] = ModelId_P.Gain1_Gain * rtb_HILReadEncoder[0];
  ModelId_B.raag[1] = ModelId_P.Gain1_Gain * rtb_HILReadEncoder[1];
  ...
  {
    t_error result = hil_read_encoder(ModelId_DW.HILInitialize_Card,
      ModelId_P.HILReadEncoder_channels, 2, &ModelId_DW.HILReadEncoder_Buffer[0]);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(ModelId_M, _rt_error_message);
    } else {
      rtb_HILReadEncoder[0] = ModelId_DW.HILReadEncoder_Buffer[0];
      rtb_HILReadEncoder[1] = ModelId_DW.HILReadEncoder_Buffer[1];
    }
  }

  /* Gain: '<Root>/Gain' */
  rtb_SineWave = ModelId_P.Gain_Gain * rtb_HILReadEncoder[0];
  ModelId_B.raag_l[0] = rtb_SineWave;

  /* SignalConversion generated from: '<Root>/To Workspace' */
  ModelId_B.TmpSignalConversionAtToWorkspac[0] = ModelId_B.raag[0];
  ModelId_B.TmpSignalConversionAtToWorkspac[2] = rtb_SineWave;

  /* Gain: '<Root>/Gain' */
  rtb_SineWave = ModelId_P.Gain_Gain * rtb_HILReadEncoder[1];
  ModelId_B.raag_l[1] = rtb_SineWave;

  /* SignalConversion generated from: '<Root>/To Workspace' */
  ModelId_B.TmpSignalConversionAtToWorkspac[1] = ModelId_B.raag[1];
  ModelId_B.TmpSignalConversionAtToWorkspac[3] = rtb_SineWave;
...
void ModelId_initialize(void)
{
  ...
  /* S-Function Block: ModelId/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    result = hil_set_card_specific_options(ModelId_DW.HILInitialize_Card, " ", 2);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(ModelId_M, _rt_error_message);
...
RT_MODEL_ModelId_T *ModelId(void)
{
  ...
  rtmSetTFinal(ModelId_M, 10.0);
  ModelId_M->Timing.stepSize0 = 0.001;
  ModelId_M->Timing.stepSize1 = 0.001;

  /* External mode info */
  ModelId_M->Sizes.checksums[0] = (1419010513U);
  ModelId_M->Sizes.checksums[1] = (3399079289U);
  ModelId_M->Sizes.checksums[2] = (3412522819U);
  ModelId_M->Sizes.checksums[3] = (3796284906U);
  ...
  ModelId_M->Sizes.numBlockPrms = (90);/* Sum of parameter "widths" */
  return ModelId_M;
}
